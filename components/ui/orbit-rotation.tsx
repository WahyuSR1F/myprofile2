    ...
    >
      <div className="relative flex items-center justify-center">
        ...
        {centerIcon && (
          <div
            className={cn(
              "bg-background/90 border-border/50 flex items-center justify-center rounded-full border shadow-xl backdrop-blur-sm z-10",
              sizeClasses[size]
            )}
          >
            <centerIcon.Icon
              className={cn(iconSizeClasses[size])}
              style={centerIcon.color ? { color: centerIcon.color } : undefined}
            />
          </div>
        )}
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        animation: `orbit-counter-spin ${animationDuration} linear infinite`,
                      }}
